    ...
    >
      ...
      <div className="grid gap-5 xl:col-start-1 xl:row-start-1">
        <div className="py-10 px-6 md:py-20 bg-neutral-800 rounded-20 flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0 animate-pulse relative">
          ...
          <div
            aria-hidden="true"
            className="text-center flex flex-col gap-3 md:text-start md:gap-6 max-w-[24rem]"
          >
        ...
        <div
          aria-hidden="true"
          className="grid gap-4 grid-cols-(--my-grid-cols-info) text-neutral-0"
        >
      ...
      <div
        aria-hidden="true"
        className="py-5 px-4 bg-neutral-800 rounded-20 grid gap-4 xl:col-start-2 xl:row-span-full max-h-[43rem] animate-pulse"
      >
