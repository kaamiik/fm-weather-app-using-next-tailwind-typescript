...
function WeatherInfo({
  ...
  return (
    <div className="py-10 px-6 bg-[url(/assets/images/bg-today-small.svg)] sm:bg-[url(/assets/images/bg-today-large.svg)] bg-no-repeat bg-cover rounded-20 flex flex-col justify-between items-center gap-4">
